    ...
    <div className="mt-20 text-black w-full flex flex-col gap-32 md:gap-4 justify-center items-center ">
      <section className="md:my-[120px]  p-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64">
        <div className="rounded-[10px] md:flex gap-8 flex-row w-full items-center">
         ...
         Global Crop Sales offers premium macadamia products, including raw kernels, in-shell nuts, and cold-pressed macadamia oil, suited for a wide range of industries. Our macadamias cater to food manufacturers, gourmet snack producers, oil extractors, and cosmetic industries seeking the finest quality. With an emphasis on consistency, flavor, and nutritional value, we support large-scale buyers in meeting their production goals. Whether supplying for gourmet snacking, baking, or cosmetic formulations, Global Crop Sales ensures a reliable supply of macadamias to enhance product lines and meet both domestic and international market demands.
            </p>
          </div>
